...
# Assert
TARGET_OTA_ASSERT_DEVICE := j2y18lte

# Bootloader"
TARGET_BOOTLOADER_BOARD_NAME := SRPQH15A000RU

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 15859984 # This is the maximum known partition size, but it can be higher, so we just omit it
